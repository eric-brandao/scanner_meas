...
name = 'Melamina_14_06_1' #'PET_grooved_plate' # 'melamine' #
main_folder = 'D:/Work/UFSM/Pesquisa/insitu_arrays/experimental_dataset/MEAS_JoaoP_GNetto/14_06/'# + name + '/'
...
ht_list = ppro_obj.compute_all_ir(yt_list, regularization = True, 
...
ppro_obj.plot_ir(ax, idir = 0, normalize = True, xlims = (00e-3, 100e-3), windowed = False)

#%%
# ht0 = ppro_obj.load_ir_byindex(idir = 0)
# ht1 = ppro_obj.load_ir_byindex(idir = 1)
#ht11 = ppro_obj.load_ir_byindex(idir = 11)

adrienne = ppro_obj.set_adrienne_win(tstart = 0.017, dt_fadein = 1e-3, t_cutoff = 30e-3, dt_fadeout = 2e-3)

#%%
ppro_obj.apply_window()

#%%
ppro_obj.ir_raw_vs_windowed(idir = 0, xlims = (15e-3, 35e-3))
#%%
