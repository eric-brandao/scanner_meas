...
import pytta
#%% Naming things
name = 'melamine_L60cm_d3cm_s100cm_2mics_01072024_s10' # Remember good practices --> samplename_arraykeyword_ddmmaaaa
...
meas_obj = ScannerMeasurement(main_folder = main_folder, name = name,
    fs = 44100, fft_degree = 20, start_stop_margin = [0.1, 6], 
...
ht.IR.plot_time(xLim = (24e-3, 50e-3))
# ht.IR.plot_freq()
...
meas_obj.sequential_measurement(repetitions = 1)
